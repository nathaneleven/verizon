...
const  Footer = () => {
    return (
    <>
        <Box border="1" bgColor="black" color="white" align="center">
            <Flex py="50px" maxW="1272px" align="center" direction={{base: "column", md: "row"}} >
                <Box>
                ...
                <Spacer/>
                <Flex align="center">
                    <Input w="80%" focusBorderColor="white" colorScheme="white" borderRadius="full" placeholder="Enter Your Email" size="lg" variant="filled" mr="3" />
                    <Button colorScheme="white" size="lg" variant="outline" borderRadius="full">Sign Up</Button>
                </Flex>
            </Flex>
            <Box p="8" bgColor="#1F1F1F" color="white" align="center"  >
            ...
            <Box p="3" bgColor="#EE0000" color="white" align="center"  >
